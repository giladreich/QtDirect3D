...
function(clangformat_setup)
  ...
  if(TARGET clang-format)
    add_dependencies(clang-format ${PROJECT_NAME}_clangformat)
  else()
    add_custom_target(clang-format DEPENDS ${PROJECT_NAME}_clangformat)
  endif()

  set_target_properties(${PROJECT_NAME}_clangformat PROPERTIES FOLDER CMakePredefinedTargets)
endfunction()
