    ...
    , m_bShowAnotherWindow(false)
{
    ...
    connect(ui->view, &QDirect3D10Widget::uiRendered, this, &MainWindow::uiRender);
}
...
void MainWindow::uiRender()
{
...

    {
        ...
        ImGui::ColorEdit4("BackColor", reinterpret_cast<float*>(ui->view->BackColor())); // Edit 3 floats representing a color
