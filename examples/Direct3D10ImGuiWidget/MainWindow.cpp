...
{
    connect(m_pScene, &QDirect3D10Widget::deviceInitialized, this, &MainWindow::init);
    connect(m_pScene, &QDirect3D10Widget::ticked, this, &MainWindow::tick);
    connect(m_pScene, &QDirect3D10Widget::rendered, this, &MainWindow::render);
    connect(m_pScene, &QDirect3D10Widget::renderedUI, this, &MainWindow::renderUI);

    // NOTE: Additionally, you can listen to some basic IO events.
    //connect(m_pScene, &QDirect3D10Widget::keyPressed, this, &MainWindow::onKeyPressed);
    //connect(m_pScene, &QDirect3D10Widget::mouseMoved, this, &MainWindow::onMouseMoved);
    //connect(m_pScene, &QDirect3D10Widget::mouseClicked, this, &MainWindow::onMouseClicked);
    //connect(m_pScene, &QDirect3D10Widget::mouseReleased, this, &MainWindow::onMouseReleased);
}
...
void MainWindow::init(bool success)
{
    ...
    disconnect(m_pScene, &QDirect3D10Widget::deviceInitialized, this, &MainWindow::init);
}
