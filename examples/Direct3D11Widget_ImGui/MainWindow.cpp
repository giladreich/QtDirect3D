...
{
    connect(m_pScene, &QDirect3D11Widget::deviceInitialized, this, &MainWindow::init);
    connect(m_pScene, &QDirect3D11Widget::ticked, this, &MainWindow::tick);
    connect(m_pScene, &QDirect3D11Widget::rendered, this, &MainWindow::render);
    connect(m_pScene, &QDirect3D11Widget::renderedUI, this, &MainWindow::renderUI);

    // NOTE: Additionally, you can listen to some basic IO events.
    //connect(m_pScene, &QDirect3D11Widget::keyPressed, this, &MainWindow::onKeyPressed);
    //connect(m_pScene, &QDirect3D11Widget::mouseMoved, this, &MainWindow::onMouseMoved);
    //connect(m_pScene, &QDirect3D11Widget::mouseClicked, this, &MainWindow::onMouseClicked);
    //connect(m_pScene, &QDirect3D11Widget::mouseReleased, this, &MainWindow::onMouseReleased);
}
...
void MainWindow::init(bool success)
{
    ...
    disconnect(m_pScene, &QDirect3D11Widget::deviceInitialized, this, &MainWindow::init);
}
