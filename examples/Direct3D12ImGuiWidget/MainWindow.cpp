    ...
    , m_bShowAnotherWindow(false)
{
    ...
    connect(ui->view, &QDirect3D12Widget::deviceInitialized, this, &MainWindow::init);
    connect(ui->view, &QDirect3D12Widget::ticked, this, &MainWindow::tick);
    connect(ui->view, &QDirect3D12Widget::rendered, this, &MainWindow::render);
    connect(ui->view, &QDirect3D12Widget::uiRendered, this, &MainWindow::uiRender);
}
...
bool MainWindow::init(bool success)
{
    ...
    m_bWindowInit = true;
    disconnect(ui->view, &QDirect3D12Widget::deviceInitialized, this, &MainWindow::init);
    return true;
}
...
void MainWindow::uiRender()
{
...

    {
        ...
        ImGui::ColorEdit4("BackColor", (float*)ui->view->backgroundColor()); // Edit 3 floats representing a color
