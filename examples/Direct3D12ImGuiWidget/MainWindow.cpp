...
void MainWindow::connectSlots()
{
    ...
    connect(m_pScene, &QDirect3D12Widget::renderedUI, this, &MainWindow::renderUI);
    ...
    //connect(m_pScene, &QDirect3D12Widget::mouseReleased, this, &MainWindow::onMouseReleased);
}
